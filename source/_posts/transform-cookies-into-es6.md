...
### ES6改写[cookies.js](https://github.com/franciscop/cookies.js/blob/master/cookies.js)
...
const cookies = function(data, opt) {
  ...
  /**
   * [defaults 源码中的合并对象属性函数 这里采用ES6的Object.assign替代,是否会引起错误？]
